...
export default function Home() {
  return (
    <main className="main-content">
      <section className="broken-grid" style={{ minHeight: '80vh', alignItems: 'center' }}>
        ...
        <div style={{ gridColumn: '1 / span 8', zIndex: 10 }}>
          <motion.h1 
            ...
            style={{ fontSize: 'clamp(3rem, 10vw, 7.5rem)', lineHeight: 0.9, letterSpacing: '-0.04em' }}
          >
        ...
        {/* Decorative element / Background depth */}
        <div style={{ gridColumn: '7 / span 6', gridRow: '1', position: 'relative', height: '100%', opacity: 0.8 }}>
          <motion.div 
      ...
      <section style={{ marginTop: 'var(--space-xxl)', borderTop: '1px solid var(--border)', paddingTop: 'var(--space-lg)', display: 'flex', justifyContent: 'space-between' }}>
